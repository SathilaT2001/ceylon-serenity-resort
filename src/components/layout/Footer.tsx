      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-xl text-primary">Ceylon Serenity Resort</h3>
            <p className="text-gray-300 text-sm">
              Experience the ultimate luxury and tranquility in the heart of Sri Lanka's paradise.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p className="pt-2">Phone: +94 123 456 789</p>
              <p>Email: info@ceylonserenity.com</p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© {new Date().getFullYear()} Ceylon Serenity Resort. All rights reserved.</p>
